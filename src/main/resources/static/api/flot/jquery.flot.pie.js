		...
		function draw(plot, newCtx) {
			...
			function drawPie() {
				...
				for (var i = 0; i < slices.length; ++i) {
					...
					drawSlice(slices[i].angle, slices[i].color, true, 0.1); // TODO 2a mudanca
				}
				ctx.restore();
				...
				if (options.series.pie.stroke.width > 0) {
					...
					for (var i = 0; i < slices.length; ++i) {	
						...
						drawSlice(slices[i].angle, options.series.pie.stroke.color, false, 0.1);
					}
					ctx.restore();
				}
